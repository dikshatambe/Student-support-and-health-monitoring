...
export class LoginComponent implements OnInit {
  ...
  constructor(private _isroot: IsrootService, private _api: DataService, private router: Router, private value: UserloginService) { }
  message: boolean;
  user_root: boolean;
  ...
  validation = function (data) {
    ...
    if (this.id == '10' && this.password == 'pucsd') {
